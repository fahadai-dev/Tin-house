...
function renderDashboard() {
 ...
 <div style="cursor:pointer;" onclick="switchView('ledger')">বাকি দিয়েছি<b>${fmt(stats.dueGiven)}</b></div>
 <div style="cursor:pointer;" onclick="switchView('cashbox')">বাকি পেয়েছি<b>${fmt(stats.dueReceived)}</b></div>
 <div>${dashboardPeriod === "day" ? "আজকে" : "এই মাসে"} পেলাম<b>${fmt(stats.received)}</b></div>
 <div>${dashboardPeriod === "day" ? "আজকে" : "এই মাসে"} দিয়েছি<b>${fmt(stats.expense)}</b></div>
 </div>
 </div>
